...
export const omni = {
    async configureProviderConnection(providerId: OmniProviderId, options: { applicationToken?: string; developerToken?: string; playbackMode?: 'musickit' | 'cider' }): Promise<void> {
        ...
        await provider.auth.configureConnection(options);
    },
