...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "settings-toggle-lattice-auto-focus": { "title": "Fokus otomatis pada lagu yang diputar", "description": "Alihkan apakah dinding poster mengikuti lagu yang diputar saat lagu berganti" },
      "lattice-poster-tint": { "title": "Warna fokus poster", "description": "Sesuaikan lapisan warna pada poster di luar fokus saat ini" },
  ...
  "home": {
    ...
    "latticeHelpPoster": "Klik poster untuk fokus dan membukanya; tekan Esc untuk kembali",
    "latticeHelpMove": "Gulir / seret dengan mouse / gunakan tombol panah untuk berpindah",
    "latticeHelpCommands": "Tekan S untuk membuka panel perintah",
    "latticeHelpOpen": "Dari tampilan lain, tekan {{modifier}} + Q untuk membuka kolase antrean",
