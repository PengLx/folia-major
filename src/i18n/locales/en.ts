...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "settings-toggle-lattice-auto-focus": { "title": "Auto-focus the playing song", "description": "Toggle whether the poster wall follows the playing song when tracks change" },
      "lattice-poster-tint": { "title": "Poster focus tint", "description": "Adjust the overlay that quiets posters outside the current focus" },
  ...
  "home": {
    ...
    "latticeHelpPoster": "Click a poster to focus and expand it; press Esc to return",
    "latticeHelpMove": "Scroll / drag with the mouse / use arrow keys to move",
    "latticeHelpCommands": "Press S to open the command palette",
    "latticeHelpOpen": "From another view, press {{modifier}} + Q to open the queue collage",
