...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "settings-toggle-lattice-auto-focus": { "title": "切歌时自动聚焦", "description": "切换歌曲时自动将正在播放的海报拉回视口中央" },
      "lattice-poster-tint": { "title": "海报聚焦叠色", "description": "调整非当前聚焦海报上的颜色叠层" },
  ...
  "home": {
    ...
    "latticeHelp": "操作提示",
    "latticeHelpPoster": "点击海报以聚焦展开，ESC返回",
    "latticeHelpMove": "滚轮移动/鼠标拖动/方向键切换",
    "latticeHelpCommands": "按S键打开命令面板以进行操作",
    "latticeHelpOpen": "在其他界面按{{modifier}} + Q打开队列拼贴",
