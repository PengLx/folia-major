...
export default {
  "appleMusic": {
    "setup": "打开 Cider 并登录 Apple Music，在 Connectivity 中启用本地 API。使用 Folia 听歌时请保持 Cider 运行，播放与音质由 Cider 处理。",
    "desktopRequired": "Apple Music 独立播放需要包含 Widevine 的 Folia 桌面端。",
    "token": "Cider 应用令牌（可选）",
    "tokenHint": "留空沿用已保存的令牌",
    "connect": "连接 / 刷新",
    "connected": "已连接 Apple Music。",
    "connectionError": "Apple Music 连接失败，请检查网络、开发者令牌和登录状态。",
    "playbackError": "Apple Music 播放失败，请检查登录、订阅及播放器状态。",
    "mode": "播放方式",
    "standalone": "Folia 独立播放",
    "standaloneSetup": "使用 Apple 账号登录。完整播放需要有效的 Apple Music 订阅。",
    "developerToken": "MusicKit 开发者令牌（JWT）",
    "librarySongs": "资料库歌曲",
    ...
    "errors": {
        ...
        "credential-storage-unavailable": "系统凭证存储不可用，无法安全保存开发者令牌。",
