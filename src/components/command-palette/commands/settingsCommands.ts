...
export const settingsCommands: CommandPaletteCommand[] = [
    ...
    createToggleCommand('settings-toggle-lattice-auto-focus', 'settings', 'Auto-focus the playing song', 'Toggle whether the poster wall follows the playing song when tracks change', ['lattice auto focus', 'follow playing song', 'follow track changes', 'poster wall follow', '切歌自动聚焦', '自动聚焦当前歌曲', '海报墙跟随'], context => context.settings.toggleLatticeAutoFocusOnSongChange()),
    defineCommand({
        id: 'lattice-poster-tint',
        group: 'settings',
        title: 'Poster focus tint',
        description: 'Adjust the overlay that quiets posters outside the current focus',
        keywords: ['lattice tint', 'poster overlay', 'focus tint', 'queue collage tint', '海报叠色', '聚焦叠层', '队列拼贴叠层'],
        icon: Layers3,
        requiresInput: true,
